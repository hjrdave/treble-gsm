...
<p>Note: Because Treble is a hook based library it will only work with functional components.  Class based components are not compatible with Treble.  See React’s <a href="https://reactjs.org/docs/hooks-intro.html">docs</a> on Hooks.</p>
